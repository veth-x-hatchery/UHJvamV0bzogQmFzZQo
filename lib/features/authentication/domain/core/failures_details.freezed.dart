...
class _$FailureDetailsTearOff {
  ...
  _FailureDetails call(
      {required String message, required LocalAuthFailure failure}) {
...
mixin _$FailureDetails {
  ...
  LocalAuthFailure get failure => throw _privateConstructorUsedError;
...
abstract class $FailureDetailsCopyWith<$Res> {
  ...
  $Res call({String message, LocalAuthFailure failure});

  $LocalAuthFailureCopyWith<$Res> get failure;
}
...
class _$FailureDetailsCopyWithImpl<$Res>
  ...
  @override
  $LocalAuthFailureCopyWith<$Res> get failure {
    return $LocalAuthFailureCopyWith<$Res>(_value.failure, (value) {
...
class _$_FailureDetails implements _FailureDetails {
  ...
  @override
  final LocalAuthFailure failure;
...
abstract class _FailureDetails implements FailureDetails {
  factory _FailureDetails(
      ...
      required LocalAuthFailure failure}) = _$_FailureDetails;
